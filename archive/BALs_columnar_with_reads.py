...
class BlockAccessListColumnar(Serializable):
    fields = [
        ...
        ('read_slots', SSZList(StorageKey, MAX_STORAGE_READS)),  # slots that were read but not written
        ('read_slot_owner', SSZList(uint32, MAX_STORAGE_READS)),  # index into addresses
